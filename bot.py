...
async def start(update: Update, context: CallbackContext) -> None:
    ...
    await update.message.reply_text(
        f"Hello {user_first_name} Please provide the topic you want to ask questions about.(The Owner: @FF_OO_X)\n"
        f"مرحبا {user_first_name} من فضلك قدم لي الموضوع الذي تريد أن تطرح عليه الأسئلة.(المالك: @FF_OO_X)"
    )
